...
router.post('/signup', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var inputs, user, newUser, token;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                inputs = req.body;
                return [4 /*yield*/, db_1.User.findOne({ username: inputs.username })];
            case 1:
                user = _a.sent();
                ...
                return [3 /*break*/, 4];
            case 2:
                newUser = new db_1.User({ username: inputs.username, password: inputs.password });
...
router.post('/login', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var inputs, user, token;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                inputs = req.body;
                return [4 /*yield*/, db_1.User.findOne({ username: inputs.username, password: inputs.password })];
            case 1:
                user = _a.sent();
                if (user) {
